"""Canonical deny-by-default managed workspace path resolution."""
...
def _raise_workspace_violation() -> Never:
    raise ToolWorkspaceError(ToolErrorCode.WORKSPACE_VIOLATION, _SAFE_PATH_ERROR)
...
def resolve_workspace_path(
    ...
    *,
    ...
    try:
        ...
        resolved = root.joinpath(relative).resolve(strict=must_exist)
